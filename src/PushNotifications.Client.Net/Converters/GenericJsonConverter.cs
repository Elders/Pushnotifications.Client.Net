...
namespace PushNotifications.Client.Net
{
    public abstract class GenericJsonConverter<TFrom, TObject> : JsonConverter
    {
        ...
        public abstract TObject Convert(TFrom jObject, Type objectType);
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            return Convert((TFrom)System.Convert.ChangeType(reader.Value, typeof(TFrom), System.Globalization.CultureInfo.InvariantCulture), objectType);
        }
